...
var countKeysInObj = function (obj, key, masterObj = {}, i = 1) {
    if (obj.hasOwnProperty(key)) {
        masterObj[key] = i;
        i++;
    }
    for (var ki in obj) {
        if (typeof obj[ki] === 'object') {
            countKeysInObj(obj[ki], key, masterObj, i);
        }
    }
...
var countValuesInObj = function(obj, value,masterObj={valueCount: 0}) {
//debugger;
    for(var key in obj){
        if(obj[key] === value){
            masterObj.valueCount = masterObj.valueCount+1;
        }
        if (typeof obj[key] === 'object') {
            countValuesInObj(obj[key], value, masterObj, masterObj.valueCount);
        }
    }
    return masterObj.valueCount;
};
...
var replaceKeysInObj = function(obj, key, newKey, masterObj={}) {
    ...
    for (var ki in obj) {
        if (typeof obj[ki] === 'object') {
            replaceKeysInObj(obj[ki], key, newKey);
        }
    }
    return obj;
};
