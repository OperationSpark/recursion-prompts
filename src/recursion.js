...
var mergeSort = function(array, ret = []) {
    var sort = (arr, element) => {
        if (arr.length === 0){
            ...
            return [arr[0]].concat(sort(arr.slice(1), element));
        }
    }
        ...
        if(array.length === 0){
            ...
            ret = sort(ret, array[0])
            return mergeSort(array.slice(1), ret);
        }
