!function () {
  ...
  if (
    ('undefined' != typeof exports
      ? ((a = !1), 'undefined' != typeof module && module.exports && (f = !0))
      : (a = !0),
    a)
  ) {
    ...
    (q.src = p.prod),
      ...
      (q.name = 'bookstrap'),
      (b.HTML_Reporter = b.mocha._reporter),
      (b.cardboard = function (a) {
        ...
        a.on('end', function () {
          ...
          b.document.body.appendChild(q),
            setTimeout(function () {
              var b = { data: a, secret: 'catreactor', url: p.api };
    ...
    d &&
      ((h = require('request')),
      (i = require('mocha').reporters.Dot),
      (k = require('fs'))),
      (process.exit = function (a) {
        h(r, function () {
    ...
    (g = function (a) {
      (m = l.match(/(?!.*hackreactor)(github.com)\W*\w*/g)[0].split('/')[1]),
        (r = {
          url: p.prod + p.api,
          method: 'POST',
